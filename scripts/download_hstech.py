"""
下载恒生科技指数（HSTECH）日K线历史数据
数据范围：2020-07-01 至 2026-02-05
...
# 恒生科技指数在东方财富的 secid（内部编号.代码）
# 市场编号: 124=恒生系列指数
HSTECH_SECID = "124.HSTECH"


def fetch_hstech_daily():
    """直接调用东方财富历史K线API获取恒生科技指数数据"""
...
def download_hstech_daily():
    """下载恒生科技指数日K线数据并保存为 JSON"""

    start_date = "2020-07-01"
    end_date = "2026-02-05"

    print(f"正在下载恒生科技指数 (HSTECH) 日K线数据...")
    ...
    output_file = os.path.join(output_dir, "hstech_daily_20200701_20260205.json")
